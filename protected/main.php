...
return array(
	...
	'components'=>array(
		...
		'db'=>array(
			'connectionString' => ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') ? 'mysql:host=localhost;dbname=cqr-off_buhgalter
' : 'mysql:host=mysql24.hosting.ua;dbname=cqr-off_buhgalter',
			'emulatePrepare' => true,
			'username' => ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') ? 'root' : 'cqr-off_testq',
			'password' => ($_SERVER['REMOTE_ADDR'] == '127.0.0.1') ? '' : 'test123QWW',
			'charset' => 'utf8',
      'tablePrefix'=>'stock_',
