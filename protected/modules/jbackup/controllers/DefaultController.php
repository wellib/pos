...
class DefaultController extends Controller
{
	...
	private function execZipFile($zipFile)
	{
        ...
        if ($res === TRUE){
            ...
            //var_dump(realpath($this->module->directoryRestoreBackup)); exit;
	...
	protected function updateMenuItems(){
		switch( $this->action->id){
			case 'upload':
            {
                $this->menu[] = array('label'=>JBackupTranslator::t('backup', 'Список резервных копий'), 'url'=>array('index'));
                $this->menu[] = array('label'=>JBackupTranslator::t('backup', 'Создать резервную копию'), 'url'=>array('create'));
            }
            break;
            default:
            {
                $this->menu[] = array('label'=>JBackupTranslator::t('backup', 'Список резервных копий'), 'url'=>array('index'));
                $this->menu[] = array('label'=>JBackupTranslator::t('backup', 'Создать резервную копию'), 'url'=>array('create'));
                $this->menu[] = array('label'=>JBackupTranslator::t('backup', 'Загрузить резервную копию'), 'url'=>array('upload'));
            }
            break;
		}
	}
