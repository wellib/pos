<tr class="rowP">
    <td class="align-center">
        <?php echo CHtml::activeTextField($model, "[$index]product_code")?>
    </td>
    ...
    <td class="i-column">
        <?php echo CHtml::dropDownList(
            "ExpectedProducts[".$index."][product_category]",
            '',
            Yii::app()->controller->getCategoriesList()); ?>
    </td>
    ...
    <td class="m-column">
        <?php echo CHtml::activeTextField($model, "[$index]product_price_b", array("class"=>"last-field align-center","onblur" => "getSubTotal($(this)); invoicePTotal();", "value"=>0,"size"=>5))?>
    </td>
    
    <td class="m-column">
        <?php echo CHtml::activeHiddenField($model, "[$index]invoice_id", array('value'=>1)); ?>
        <?php echo CHtml::activeTextField($model, "[$index]product_price", array("class"=>"last-field align-center","value"=>0,"size"=>5))?>
    </td>
