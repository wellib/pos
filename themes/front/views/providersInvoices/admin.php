...
<h2>Управление накладными поставщикам <?php echo CHtml::link("Добавить",array("providersInvoices/create",),array('class'=>'create-button btn btn-primary btn-xs')) ?></h2>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'headerHtmlOptions'=>array('class'=>'active'),
            'type'=>'raw',
            'value'=>'CHtml::link($data->invoiceUser->username,array("users/update/$data->invoice_receiver",))',
            'filter'=>'',
        ),
        array(
            'name'=>'invoice_summ',
