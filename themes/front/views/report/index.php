...
<div class="form" >
    <div class="col-lg-6">
     ...
     <div class="col-lg-6">
        <div class="alert alert-info invoice-type">
            <a href="/report/sales" ><strong>Продажи товара</strong></a>
        </div>
    </div>
    ...
    <div class="col-lg-6">
     ...
     <div class="col-lg-6">
        <div class="alert alert-info invoice-type">
            <a href="/report/r1" ><strong>Отчет по поступившим и выбывшим товарам</strong></a>
        </div>
    </div>

     <div class="col-lg-6">
        <div class="alert alert-info invoice-type">
            <a href="/report/r2" ><strong>Отчет профит</strong></a>
        </div>
    </div>

     <div class="col-lg-6">
        <div class="alert alert-info invoice-type">
            <a href="/report/r3" ><strong>Отчет по продажам</strong></a>
        </div>
    </div>
