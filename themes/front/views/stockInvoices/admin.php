...
<h2>Управление накладные на внутреннее перемещение <?php echo CHtml::link("Добавить",array("stockInvoices/create",),array('class'=>'create-button btn btn-primary btn-xs')) ?></h2>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'type'=>'raw',
            'value'=>'CHtml::link($data->invoiceSender->username,array("users/update/$data->invoice_sender",))',
            'filter'=>'',
        ),
        array(
            ...
            'headerHtmlOptions'=>array('class'=>'active'),
            'type'=>'raw',
            'value'=>'CHtml::link($data->invoiceReceiver->username,array("users/update/$data->invoice_receiver",))',
            'filter'=>'',
        ),
        array(
            'name'=>'invoice_summ',
